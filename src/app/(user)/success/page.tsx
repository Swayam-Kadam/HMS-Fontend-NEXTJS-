...
import VerifyAppointmentPayment from '@/components/appointment/VerifyAppointmentPayment';
    ...
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-16">
      ...
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-xl border border-gray-100 p-10 text-center">
        ...
        <p className="text-gray-600 mb-8">
          Your appointment has been booked and payment was received. A confirmation email will be sent shortly.
        </p>
